...
Para el modelo entrenado con el dataset de internet y testeado con el dataset de internet

```{r,include=FALSE}
svm_feat_internet<-readRDS("modelos_MFCC/modelo_svm_feat.rds")
df_test_internet_ml<-readRDS("modelos_MFCC/df_test_ml.rds")
df_test_internet_ok<-readRDS("modelos_MFCC/df_test_ok.rds")
```
...
Para el modelo entrenado con el dataset de internet testeado con nuestro dataset

```{r,include=FALSE}
df_test_nuestro_ml_total<-readRDS("modelos_MFCC/df_test_ml_nuestro_total.rds")
df_test_nuestro_ok_total<-readRDS("modelos_MFCC/df_test_ok_nuestro_total.rds")
```
...
Para el modelo entrenado con nuestro dataset testeado con nuestro dataset

```{r}
svm_feat_nuestro<-readRDS("modelos_MFCC/svm_fit_nuestro.rds")
df_test_nuestro_ml<-readRDS("modelos_MFCC/df_test_ml_nuestro.rds")
df_test_nuestro_ok<-readRDS("modelos_MFCC/df_test_ok_nuestro.rds")
```
