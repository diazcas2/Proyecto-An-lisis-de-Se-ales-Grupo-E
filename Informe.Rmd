...
```{r, echo=FALSE, fig.cap="Distribución del ZCR por Acento"}
ggplot(voces_modif, aes(x = acento, y = zcr, fill = acento)) + geom_boxplot() + labs(title = "Distribución del ZCR por Acento", y = "Zero Crossing Rate") + theme_minimal()
```
