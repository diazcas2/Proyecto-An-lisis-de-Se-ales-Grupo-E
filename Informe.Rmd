...
En este trabajo se ha llevado a cabo un análisis completo de señales de voz, partiendo de grabaciones propias y de audios generados por inteligencia artificial. Tras el preprocesado de las señales, se extrajeron distintas características acústicas que permitieron representar cada audio de forma numérica y construir conjuntos de datos adecuados para el entrenamiento de modelos de clasificación.

En relación con los objetivos planteados, se ha conseguido desarrollar un modelo eficaz para la clasificación del sexo del hablante, así como un modelo capaz de distinguir entre voces humanas y voces generadas por IA, mostrando un buen rendimiento. Por el contrario,tal y como se ha visto, la clasificación del acento no ha producido resultados concluyentes, principalmente debido al tamaño reducido y a la baja diversidad de la muestra disponible por acento.

En conjunto, los resultados obtenidos muestran que las características acústicas extraídas contienen información relevante para tareas de clasificación de voz y que los modelos propuestos permiten abordar con éxito algunos de los objetivos planteados. Al mismo tiempo, el estudio pone de manifiesto la importancia de disponer de conjuntos de datos más amplios y variados para problemas más complejos, como la identificación de acentos.
