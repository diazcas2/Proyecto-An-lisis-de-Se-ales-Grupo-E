...
En lo que respecta a los objetivos previamente planteados, cabe destacar que se ha conseguido desarrollar un modelo eficaz para la clasificación del sexo del hablante y otro capaz de distinguir entre voces humanas y generadas por inteligencia artificial, ambos con un rendimiento satisfactorio, lo que demuestra la viabilidad de analizar señales de voz mediante la extracción de determinadas características acústicas. 

Por el contrario, la clasificación del acento no ha producido resultados concluyentes, debido principalmente al tamaño reducido y a la limitada diversidad de la muestra disponible para cada acento, lo que pone de manifiesto que tareas más complejas requieren conjuntos de datos más amplios y representativos para poder obtener resultados robustos.