...
```{r}
df_test_nuestro_ml_total<-readRDS("testeo_audios_nuestros/df_test_ml_nuestro_total.rds")
df_test_nuestro_ok_total<-readRDS("testeo_audios_nuestros/df_test_ok_nuestro_total.rds")
```
