...
```{r}
svm_fit <- readRDS("modelo_svm_feat.rds")
```
...
df_test <- build_feat_dataframe(
  real_dir = "for-norm/testing/real",
  ia_dir   = "for-norm/testing/fake",
  target_sr = 16000,
  dither = FALSE
)
```
...
```{r}
saveRDS(df_test_ml, "testeo_audios_nuestros/df_test_ml_nuestro.rds")
saveRDS(df_test_ok, "testeo_audios_nuestros/df_test_ok_nuestro.rds")
```
